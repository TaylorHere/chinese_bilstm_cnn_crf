...
class DataPreprocess():
    ...
    def create_documents(self):
        ...
        chars_file = codecs.open(self.trainPath.data_path, "w", "utf-8")
        labels_file = codecs.open(self.trainPath.label_path, "w", "utf-8")

        with codecs.open(self.trainPath.train_data_path, "r", "utf-8") as f:
            for line in f:
    ...
    def create_lexicon(self, word_dict):
        ...
        chars = {}
        # 统计词出现的次数
        with codecs.open(self.trainPath.data_path, "r", "utf-8") as f:
            line = f.readline()
            while line:
    ...
    def create_embedding(self, embedding_model, embedding_size, lexicon_reverse):
        ...
        word_dict = self.create_useful_words(embedding_model)
    ...
    def create_matrix(self, lexicon, label_2_index):
        ...
        data_index = codecs.open(self.trainPath.data_index_path, "w", "utf-8")
        label_index = codecs.open(self.trainPath.label_index_path, "w", "utf-8")

        file_chars = codecs.open(self.trainPath.data_path, "r", "utf-8")
        file_labels = codecs.open(self.trainPath.label_path, "r", "utf-8")
