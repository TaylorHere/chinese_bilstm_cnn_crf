...
class FTML(Optimizer):
    ...
    def __init__(
        self, lr=0.0025, beta_1=0.6, beta_2=0.999, epsilon=1e-8, decay=0.0, **kwargs
    ):
    ...
    def get_updates(self, loss, params):
        ...
        lr_t = lr / (1.0 - K.pow(self.beta_1, t))
        ...
        for p, g, z, v, d in zip(params, grads, zs, vs, ds):
            ...
            d_t = (K.sqrt(v_t / (1.0 - K.pow(self.beta_2, t))) + self.epsilon) / lr_t
            sigma_t = d_t - self.beta_1 * d
            z_t = self.beta_1 * z + (1.0 - self.beta_1) * g - sigma_t * p
