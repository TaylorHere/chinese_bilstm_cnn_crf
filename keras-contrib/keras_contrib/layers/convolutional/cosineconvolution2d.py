...
class CosineConvolution2D(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel_norm = K.variable(
            np.ones(self.kernel_norm_shape), name=kernel_norm_name
        )
    ...
    def compute_output_shape(self, input_shape):
        ...
        rows = conv_output_length(rows, self.nb_row, self.padding, self.strides[0])
        cols = conv_output_length(cols, self.nb_col, self.padding, self.strides[1])
