...
TH_WEIGHTS_PATH_NO_TOP = (
    "https://github.com/titu1994/Wide-Residual-Networks/releases/"
            ...
            if K.image_dim_ordering() == "th":
                if include_top:
                    ...
                    weights_path = get_file(
                        h5_file, TH_WEIGHTS_PATH, cache_subdir="models"
                    )
                else:
                    h5_file = "wide_resnet_28_8_th_dim_ordering_th_kernels_no_top.h5"
                    weights_path = get_file(
                        h5_file, TH_WEIGHTS_PATH_NO_TOP, cache_subdir="models"
                    )
                ...
                if include_top:
                    ...
                    weights_path = get_file(
                        h5_file, TF_WEIGHTS_PATH, cache_subdir="models"
                    )
                else:
                    h5_file = "wide_resnet_28_8_tf_dim_ordering_tf_kernels_no_top.h5"
                    weights_path = get_file(
                        h5_file, TF_WEIGHTS_PATH_NO_TOP, cache_subdir="models"
                    )
